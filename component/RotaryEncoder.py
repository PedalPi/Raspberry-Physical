...
class RotaryEncoderWithButton(object):
    ...
    def __init__(self, pinMinus, pinPlus, selectPin, pullUp=False):
        self.encoder = RotaryEncoder(pinMinus, pinPlus, pullUp)
        self.button = Button(selectPin, pullUp)
    ...
    @when_selected.setter
    def when_selected(self, action):
